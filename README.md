...
4. Railway auto-detects `nixpacks.toml`, downloads the standalone Linux `yt-dlp` binary, and installs `ffmpeg`
...
- **Railway** = real Linux container with Nix → ffmpeg from Nix and the standalone Linux yt-dlp release binary ✅
